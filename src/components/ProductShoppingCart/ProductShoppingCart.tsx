...
import { ActionsShoppingCart, ProductProps } from '../../types';
...
export const ProductShoppingCart: React.FC<ProductProps & ActionsShoppingCart> = 
({ id, img, title, price, rate, attribute, discount }) => {
  const removeProduct = useStoreOfShoppingCart(state => state.removeProduct);
  return (
    <li className="cart__item">
      ...
      <div className="cart__result">
        <button className="cart__delete" onClick={() => {if (removeProduct) removeProduct(id)}}>
